...
.provider('HeatmapHelper', function HeatmapHelper() {
  ...
  this.$get = function () {
    return {
      drawDelay: 1,
      cubeTemplate: '<div class="heatmap-cube-container"  title="$tooltip$" style="width: $width$;height: $height$;top: $top$; left:$left$;" ><div class="heatmap-cube" style="background-color:$color$" value="$value$"><span style="line-height:$height$">$value$</span></div></div>',
